...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that perorms an affine transform followed by bn and a ReLU
    ...
    """
    a, fc_cache = affine_forward(x, w, b)
    outbn, bn_cache = batchnorm_forward(a, gamma, beta, bn_param)
...
def affine_ln_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that perorms an affine transform followed by layer norm and a ReLU
    ...
    """
    a, fc_cache = affine_forward(x, w, b)
    outbn, bn_cache = layernorm_forward(a, gamma, beta, bn_param)
    out, relu_cache = relu_forward(outbn)
